...
roots_core += uk.ac.lancs.networks.mgmt.ExpiredTrunkException
...
roots_core += uk.ac.lancs.networks.jsoncmd.MultiplexingJsonServer
roots_core += uk.ac.lancs.networks.jsoncmd.MultiplexingJsonClient
roots_core += uk.ac.lancs.networks.transients.DummySwitchAgentFactory
